...
export const API_URLS = {
  ...
  INSERT_ORDER: buildApiUrl(API_CONFIG.ENDPOINTS.INSERT_ORDER),
  ...
  DELIVERY_DISTANCE: buildApiUrl(API_CONFIG.ENDPOINTS.DELIVERY_DISTANCE),
  DELIVERY_STATUS: API_CONFIG.ENDPOINTS.DELIVERY_STATUS,
  DELIVERY_ORDERS: API_CONFIG.ENDPOINTS.DELIVERY_ORDERS
} as const;
